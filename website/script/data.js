var indexData = {
  en: {
    ...
    description:
      'Hi,I am eveningWater,Web developer from chengdu,Sichuan,China.I am passionate about development,interaction and design.I really love what I do.',
    btn: [
      {
        id: 'about',
        content: 'About'
  ...
  zh: {
    who: '我是夕水',
    description:
      '哈喽，我是夕水，一名来自中国四川成都的web开发工程师。我对开发、交互以及设计充满热情。我真的很喜欢我的工作。',
    btn: [
      {
        id: 'about',
        content: '关于'
...
var contactData = {
  en: {
    ...
    title: 'Contact',
    description:
      'If you have any questions, you can leave me a message at any time.',
...
var aboutData = {
  en: {
    ...
    title: 'About',
    description:
      'Hi,I am eveningWater,Web developer from chengdu,Sichuan,China.',
...
var workData = {
  en: {
    ...
    title: 'Work',
    description:
      "This is a selection of my web development work. I've been involve in many different types of project.",
    content: ''
  },
  zh: {
    backBtnText: '回到首页',
