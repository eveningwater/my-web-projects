...
createPopBox.prototype.renderStyle = function (option) {
    ...
    style.textContent = ".ew-popBox-mask {position: fixed;left: 0;right: 0;top: 0;bottom: 0;background-color: rgba(0, 0, 0, 0.6);z-index: 10000;transition:all .6s;}" +
...
createPopBox.prototype._renderPopBox = function (option) {
    ...
    let popBoxHTML = '<div class="ew-popBox-mask hidden">' +
        '<div class="ew-popBox">' +
